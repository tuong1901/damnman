...
class Conv3BN(nn.Module):
    """Convolution with Batch Normalization (no activation)."""

    def __init__(self, c1, c2, s=1, k=3, p=None, g=1, d=1):
        """
        Initialize Conv3BN layer with given parameters.
    ...
    def forward(self, x):
        """
        Apply convolution and batch normalization to input tensor.
...
class InvertedResidual(nn.Module):
    ...
    def __init__(self, c1, c2, hidden_dim, kernel_size, stride, expand_ratio, use_se):
        """
        Initialize InvertedResidual block.

        Args:
            c1 (int): Number of input channels (auto-provided by ultralytics).
            c2 (int): Number of output channels (auto-provided by ultralytics).
            hidden_dim (int): Hidden dimension for expansion layer.
            kernel_size (int): Kernel size for depthwise convolution.
            stride (int): Stride for depthwise convolution.
            expand_ratio (float): Expansion ratio for intermediate channels.
    ...
    def forward(self, x):
        """
        Forward pass of InvertedResidual block.
...
class SELayer(nn.Module):
    ...
    def __init__(self, channel, reduction=4):
        ...
        Args:
            ...
            reduction (int): Reduction ratio for hidden layer.
        """
        super().__init__()
